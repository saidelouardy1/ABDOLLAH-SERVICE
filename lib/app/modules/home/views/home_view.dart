...
import 'package:abdollah_srevice/app/modules/home/Pages/description_item.dart';
                  ...
                  children: [
                    Center(
                      child: Column(
                        children: [
                          CircleAvatar(
                            backgroundImage: NetworkImage(homeController.photoUser.value),
                            radius: 30,
                          ),
                          SizedBox(height: 8),
                          Text(
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: AssetImage(homeController.image_PageViwe[index]),
                                            opacity: 0.5,
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                            ...
                            children: List.generate(
                              ...
                              (index) => Obx(
                                () => Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: homeController.currentIndex.value == index ? Colors.black : Colors.grey,
                                    shape: BoxShape.circle,
                                  ),
                                ),
                              ),
                          ...
                          Obx(() {
                            return homeController.isLoadingService.value
                                ? SizedBox(
                                    height: Get.height / 3,
                                ...
                                : ListView.builder(
                                    ...
                                    physics: NeverScrollableScrollPhysics(),
                                    itemBuilder: (context, index) {
                                      var service = homeController.AllService[index];
                                      String serviceId = service.id;
                                      bool isLiked = (service['PersonWhoDoLikes'] as List).contains(firebaseService.currentId);
                                      return InkWell(
                                        onTap: () {
                                          Get.to(DescriptionItem());
                                        },
                                        child: Container(
                                          width: Get.width,
                                          height: 250,
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          IconButton(
                                                            onPressed: () {
                                                              firebaseService.toggleLikeAndIncrementWonder(serviceId);
                                                            },
                                                            icon: SvgPicture.asset(
                                                               isLiked? Images_Icon.heart_fille : Images_Icon.Heart,
                                                              width: 20,
                                                              height: 20,
                                                              color: Colors.black,
                                                            ),
